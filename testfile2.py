...
while(cap.isOpened()):
    ...
    cv2.rectangle(gray,(215,75),(250,250),(0,255,0),1)
    cv2.rectangle(gray,(180,75),(215,140),(0,255,0),1)
    cv2.rectangle(gray,(145,75),(180,140),(255,0,0),0) 
    cv2.rectangle(gray,(110,75),(145,140),(255,0,255),0) 
    cv2.rectangle(gray,(75,222),(110,140),(255,0,255),0)
    cv2.line(gray, (75, 168), (110, 168), (255, 0, 255), 1) 
    cv2.line(gray,(75,195),(110,195),(255,0,255),1)
    cv2.rectangle(gray,(75,222),(145,250),(255,0,255),0)
    crop_img = gray[75:250, 75:250]
    value = (15,15)
    blurred = cv2.GaussianBlur(crop_img, value, 0)
    _, thresh1 = cv2.threshold(blurred, 5, 255,
